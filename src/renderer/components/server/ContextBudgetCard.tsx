...
export function ContextBudgetCard({ server }: ContextBudgetCardProps): React.JSX.Element | null {
  ...
  return (
    <div className="flex flex-col gap-4 rounded-[10px] border border-border bg-bg-surface p-4">
      ...
      <div className="flex items-center justify-between border-t border-border-soft pt-3 text-[12.5px] text-text-muted">
        <span>
          Footprint in a{' '}
